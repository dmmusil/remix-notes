...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create remix-2e85
  fly create remix-2e85-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-2e85
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-2e85-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-2e85-staging' does not match app name in config file 'remix-2e85'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-2e85-db
  fly postgres attach --postgres-app remix-2e85-db --app remix-2e85

  fly postgres create --name remix-2e85-staging-db
  fly postgres attach --postgres-app remix-2e85-staging-db --app remix-2e85-staging
  ```
